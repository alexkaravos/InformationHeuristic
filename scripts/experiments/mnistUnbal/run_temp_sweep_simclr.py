...
"""
Temperature sweep script for SimCLR training on unbalanced MNIST
...
def run_temperature_sweep():
    ...
    print("Starting temperature sweep for SimCLR training on unbalanced MNIST")
    ...
    print("Results saved in: weights/mnistUnbal/representations/simclr/")
