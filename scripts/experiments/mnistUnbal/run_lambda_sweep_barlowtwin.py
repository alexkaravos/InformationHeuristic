...
"""
Lambda sweep script for Barlow Twins training on unbalanced MNIST
...
def run_lambda_sweep():
    ...
    print("Starting lambda sweep for Barlow Twins training on unbalanced MNIST")
    ...
    for lmbda in lambda_values:
        ...
        try:
            ...
            result = subprocess.run([
                sys.executable, 
                str(train_script), 
                f"experiments.mnistUnbal.representations.lambda_param={lmbda}"
    ...
    print("Results saved in: weights/mnistUnbal/representations/barlowtwin/")
