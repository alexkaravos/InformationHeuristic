...
@hydra.main(config_path="../../../configs", config_name="experiments/mnistUnbal/mnistUnbal_simclr", version_base=None)
def main(cfg: DictConfig):
    ...
    # Load dataset
    train_dataset,test_dataset, full_dataset = mnist_unbalanced_dataset(
    ...
    # Create model
    save_dir = os.path.join(cfg.save_dir, f"simclr_{cfg.models.arch}_{cfg.representations.temperature*1000:.2f}")
