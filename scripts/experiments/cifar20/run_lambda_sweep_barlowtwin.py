...
"""
Lambda sweep script for Barlow Twins training on CIFAR-20
...
def run_lambda_sweep():
    ...
    print("Starting lambda sweep for Barlow Twins training on CIFAR-20")
    ...
    for lmbda in lambda_values:
        ...
        try:
            result = subprocess.run([
                sys.executable,
                str(train_script),
                f"experiments.cifar20.representations.lambda_param={lmbda}"
    ...
    print("Results saved in: weights/cifar20/representations/barlowtwin/")
