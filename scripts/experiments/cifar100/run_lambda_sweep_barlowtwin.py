...
def run_lambda_sweep():
    ...
    lambda_values = [0.0033, 0.004, 0.005 , 0.0066, 0.010]
    
    script_dir = Path(__file__).parent
    train_script = script_dir / "train_barlowtwin.py"
    
    print("Starting lambda sweep for Barlow Twins training on CIFAR-100")
    ...
    print("Results saved in: weights/cifar100/representations/barlowtwin/")
