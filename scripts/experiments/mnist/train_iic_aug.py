...
from src.models.clustering import MLP_dict,Connected_Clusterer
from src.clustering.training import train_paired_aug
from src.clustering.losses import IIC_loss

@hydra.main(config_path="../../../configs", config_name="experiments/mnist/mnist_iic_aug_barlow", version_base=None)
...
def main(cfg: DictConfig):
    ...
    # Load dataset
    _,_, full_dataset = mnist_dataset(
