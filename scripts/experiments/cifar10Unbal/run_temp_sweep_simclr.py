...
"""
Temperature sweep script for SimCLR training on unbalanced CIFAR-10
...
def run_temperature_sweep():
    ...
    print("Starting temperature sweep for SimCLR training on unbalanced CIFAR-10")
    ...
    for temp in temperatures:
        ...
        try:
            ...
            result = subprocess.run([
                sys.executable,
                str(train_script),
                f"experiments.cifar10Unbal.representations.temperature={temp}"
    ...
    print("Results saved in: weights/cifar10Unbal/representations/simclr/")
