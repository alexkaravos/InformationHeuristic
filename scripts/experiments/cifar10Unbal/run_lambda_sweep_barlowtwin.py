...
"""
Lambda sweep script for Barlow Twins training on unbalanced CIFAR-10
...
def run_lambda_sweep():
    ...
    print("Starting lambda sweep for Barlow Twins training on unbalanced CIFAR-10")
    ...
    for lmbda in lambda_values:
        ...
        try:
            ...
            result = subprocess.run([
                sys.executable,
                str(train_script),
                f"experiments.cifar10Unbal.representations.lambda_param={lmbda}"
    ...
    print("Results saved in: weights/cifar10Unbal/representations/barlowtwin/")
