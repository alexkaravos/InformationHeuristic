...
@hydra.main(config_path="../../../configs", config_name="experiments/cifar10Unbal/cifar10Unbal_barlowtwin", version_base=None)
def main(cfg: DictConfig):
    # Flatten the config
    cfg = cfg.experiments.cifar10Unbal
    ...
    # Load dataset
    dataset_func = getattr(datasets, cfg.datasets.dataset_func)
    train_dataset,test_dataset, full_dataset = dataset_func(
